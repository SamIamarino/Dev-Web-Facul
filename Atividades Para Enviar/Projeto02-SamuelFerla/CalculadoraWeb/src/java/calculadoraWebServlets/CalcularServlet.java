 ...
 */
package calculadoraWebServlets;
...
public class CalcularServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        switch(request.getParameter("operacao")){
            ...
            case "-":
                result = num1 - num2;
                System.out.println("A subtração eh: " + result);
                break;
            ...
            case "/":
                ...
                if(num2 == 0){
                    ...
                    System.out.println("A divisao eh: " + result);
                }
                break;
                
            case "*":
                result = num1 * num2;
                System.out.println("A multiplicacao eh: " + result);
                break; 
