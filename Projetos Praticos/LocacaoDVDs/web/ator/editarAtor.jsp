...
<html lang="en" id="main">
  <head>
    ...
    <link rel="stylesheet" href="${cp}/css/atorStyle.css" />
  </head>
  <body>
    <header class="header">
      <nav>
      ...
      <div class="main-container">
        ...
        <div class="header-body">
          <form action="${cp}/processaAtor" method="post">
            ...
            <label>Nome: </label>
            <input type="text" name="nomeAtor" class="form-input" value="${requestScope.ator.nome}"/>

            <label>Sobrenome: </label>
            <input type="text" name="sobrenomeAtor" class="form-input" value="${requestScope.ator.sobrenome}"/>

            <label>Data Estreia: </label>
            <input type="date" name="dataEstreia" class="form-input" value="${requestScope.ator.dataEstreia}"/>
