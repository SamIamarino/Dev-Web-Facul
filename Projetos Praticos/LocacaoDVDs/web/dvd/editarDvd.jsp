      ...
      <div class="main-container">
        ...
        <div class="header-body">
          <form action="${cp}/processaDvd" method="post">
            ...
            <input type="hidden" name="id" value="${requestScope.dvd.dvdID}" />

            <label>Título: </label>
            <input type="text" name="nomeDvd" class="form-input" value="${requestScope.dvd.titulo}"/>

            <label>Ano Lancamento: </label>
            <input type="text" name="anoLancamentoDvd" class="form-input" value="${requestScope.dvd.anoLancamento}"/>

           
            <label>Data Lançamento: </label>
            <input type="date" name="dataLancamentoDvd" class="form-input" value="${requestScope.dvd.dataLancamento}"/>

            <label>Duração(Min): </label>
            <input type="text" name="duracaoDvd" class="form-input" value="${requestScope.dvd.duracaoMinutos}"/>
